                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <strong>Address:</strong> {{ $boardingHouse->address }} <br>
                                        <strong>Rent Price:</strong> {{ $boardingHouse->rent_price }} <br>
                                        <strong>Similarity Score:</strong> {{ number_format($result['similarity_score'] * 100, 2) }}%
                                    </p>
        
                                    <h6>Preferences:</h6>
                                    <ul>
                                        @foreach ($boardingHouse->preferences as $preference)
