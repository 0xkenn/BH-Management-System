        ...
        <ul class="space-y-4">
            ...
            <li class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="flex items-center space-x-4">
                    <!-- BH Image -->
                    <img src="https://via.placeholder.com/50" alt="BH Image" class="w-12 h-12 rounded-full object-cover border-2 border-gray-300">

                    <!-- BH Name and Owner -->
                    <div>
                        <span class="block font-bold text-lg">BH Name 1</span>
                        <span class="block font-bold text-gray-600">Owner: John Doe</span>
                    </div>
                </div>
            ...
            <li class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center space-x-4">
                    <img src="https://via.placeholder.com/50" alt="BH Image" class="w-12 h-12 rounded-full object-cover border-2 border-gray-300">
                    <div>
                        <span class="block font-bold text-lg">BH Name 2</span>
                        <span class="block font-bold text-gray-600">Owner: Jane Smith</span>
                    </div>
                </div>
                <button class="text-red-500 hover:text-red-700 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
            ...
            <li class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center space-x-4">
                    <img src="https://via.placeholder.com/50" alt="BH Image" class="w-12 h-12 rounded-full object-cover border-2 border-gray-300">
                    <div>
                        <span class="block font-bold text-lg">BH Name 3</span>
                        <span class="block font-bold text-gray-600">Owner: Alice Brown</span>
                    </div>
                </div>
                <button class="text-red-500 hover:text-red-700 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
