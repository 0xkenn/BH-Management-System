        ...
        <div class="max-w-5xl rounded-lg overflow-hidden shadow-lg bg-white"> <!-- Increased width -->
            ...
            <div class="px-8 pt-4 pb-6">
                <div class="inline-block">
                    <button x-data="{ savedRoom: @js($savedRoom) }"
                            @click="axios.post(`/save-room/{{$room->id}}`).then(res => { savedRoom = res.data }).catch(e => console.log(`error is ${e.message}`))"
                            ...
                            :class="savedRoom ? 'bg-green-700 hover:bg-green-800 focus:ring-green-300' : 'bg-blue-600 hover:bg-blue-600 focus:ring-blue-300'">
